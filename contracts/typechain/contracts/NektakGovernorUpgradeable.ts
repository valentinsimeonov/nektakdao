...
export interface NektakGovernorUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface NektakGovernorUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): NektakGovernorUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: NektakGovernorUpgradeableInterface;
  ...
  initialize: TypedContractMethod<
    [tokenAddr: AddressLike, timelockAddr: AddressLike],
    [void],
    "nonpayable"
  >;
