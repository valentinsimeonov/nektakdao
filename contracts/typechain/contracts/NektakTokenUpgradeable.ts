...
export interface NektakTokenUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DOMAIN_SEPARATOR"
...
export interface NektakTokenUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): NektakTokenUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: NektakTokenUpgradeableInterface;
