...
export interface TimelockControllerUpgradeableUUPSInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CANCELLER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface TimelockControllerUpgradeableUUPS extends BaseContract {
  connect(runner?: ContractRunner | null): TimelockControllerUpgradeableUUPS;
  waitForDeployment(): Promise<this>;

  interface: TimelockControllerUpgradeableUUPSInterface;
